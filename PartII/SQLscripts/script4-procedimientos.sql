...
IS
BEGIN
    INSERT INTO productos(nombre, familia,precio, numReferencia, coste, stock,
    cantidadCritica) values(w_nombre, w_familia, w_precio, w_numReferencia, w_coste, w_stock,
    w_cantidadCritica);
